(function () {
  ...
  data.officeLadder = [
    { id: "educationBoard", name: "Local Education Board", tier: 1, electorate: "local", duties: ["schools", "budgets", "student services"], campaignScale: 0.62, governingPower: 0.55 },
    ...
    { id: "provincialAssembly", name: "Provincial Assembly", tier: 4, electorate: "regional", duties: ["state policy", "coalitions", "legislation"], campaignScale: 1, governingPower: 0.85 },
    { id: "regionalSenate", name: "Regional Senate", tier: 5, electorate: "regional", duties: ["long-term legislation", "oversight"], campaignScale: 1.18, governingPower: 0.9 },
    { id: "governor", name: "Governor", tier: 6, electorate: "statewide", duties: ["executive agenda", "crises", "budget"], campaignScale: 1.38, governingPower: 1.2 },
    { id: "nationalAssembly", name: "National Assembly", tier: 7, electorate: "national district", duties: ["national legislation", "party caucus"], campaignScale: 1.55, governingPower: 1 },
    { id: "nationalSenate", name: "National Senate", tier: 8, electorate: "national statewide", duties: ["national policy", "major coalitions"], campaignScale: 1.78, governingPower: 1.1 },
    { id: "chancellor", name: "Chancellor", tier: 9, electorate: "national", duties: ["national executive", "foreign affairs", "legacy"], campaignScale: 2, governingPower: 1.5 }
  ];
  ...
  data.factions = [
    { id: "progressiveBloc", name: "Progressive Bloc", seats: 5, support: 54, priorities: ["housing", "labor", "civilRights"] },
    { id: "laborCaucus", name: "Labor Caucus", seats: 4, support: 58, priorities: ["labor", "education", "healthcare"] },
    { id: "greenAlliance", name: "Green Alliance", seats: 3, support: 55, priorities: ["climate", "transportation", "housing"] },
    { id: "moderateReformers", name: "Moderate Reformers", seats: 6, support: 52, priorities: ["budget", "education", "government"] },
    { id: "businessConservatives", name: "Business Conservatives", seats: 5, support: 43, priorities: ["taxes", "economicDevelopment", "budget"] },
  ...
  data.governingEvents = [
    {
      ...
      body: "Your team gathers around a scratched conference table. The campaign is over. Every promise now has a cost, a calendar, and an opponent.",
      choices: [
  ...
  data.civicTutorial = [
    { title: "Premise", body: "In The Common Republic, you begin as a local political candidate. You campaign, win office, govern, pass policies, respond to crises, and build a career." },
    { title: "Dashboard", body: "Money buys communication. Time and energy limit actions. Volunteers improve turnout. Public trust changes how voters interpret choices." },
    { title: "First action", body: "Use a town hall to increase trust. Campaign actions have costs and usually affect regions, voter groups, or both." },
    { title: "Second action", body: "Canvassing a swing region improves turnout and persuasion. Polls move, but they include uncertainty." },
    { title: "Events", body: "Written events ask you to choose a response. Good choices are rarely free: one group may cheer while another worries." },
    { title: "Governing", body: "Winning is not the end. In office, you manage advisors, budget, policies, factions, approval, and future elections." }
  ];
