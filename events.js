window.CommonPagesCivicData.events = [
  ...
  },
  {
    ...
    choices: [
      ...
      { label: "Say, 'Columbia needs courage, not caretaking.'", text: "The sharper line excites some voters and alarms others.", effects: { media: 2, groups: { collegeStudents: 1, veterans: 1, seniors: -1, suburbanModerates: -0.7 } } }
    ]
  }
];
